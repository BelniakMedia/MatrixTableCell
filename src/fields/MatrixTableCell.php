...
namespace BelniakMedia\MatrixTableCell\fields;

use BelniakMedia\MatrixTableCell\assetbundles\matrixtablecell\MatrixTableCellAsset;
 ...
 * @since     1.0.0
 */
class MatrixTableCell extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('matrix-table-cell', 'MatrixTableCell');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'matrix-table-cell/_components/fields/MatrixTableCell_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(MatrixTableCellAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').MatrixTableCellMatrixTableCell(" . $jsonVars . ");");

        // Set default value if none specified
		if(!is_array($value) || !sizeof($value)) {
			$value = [["data" => "", "class" => "", "colspan" => 0, "align" => "left"]];
		}

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'matrix-table-cell/_components/fields/MatrixTableCell_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
