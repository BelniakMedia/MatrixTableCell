...
namespace BelniakMedia\MatrixTableCell;

use BelniakMedia\MatrixTableCell\fields\MatrixTableCell as MatrixTableCellField;
 ...
 *
 */
class MatrixTableCell extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = MatrixTableCellField::class;
            }
        );
